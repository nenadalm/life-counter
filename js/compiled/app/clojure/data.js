...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__13849){
...
var vec__13853 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13853,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13853,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13853,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_13859 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_13859(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_13860 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_13860(a,b);
}
});
...
var fexpr__13865 = (function (){var G__13866 = clojure.data.equality_partition(a);
var G__13866__$1 = (((G__13866 instanceof cljs.core.Keyword))?G__13866.fqn:null);
switch (G__13866__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13866__$1)].join('')));

}
})();
return (fexpr__13865.cljs$core$IFn$_invoke$arity$2 ? fexpr__13865.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__13865.call(null,a,b));
}));
/**
