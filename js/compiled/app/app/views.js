...
app.views.amount_modifier = (function app$views$amount_modifier(p__14195){
var map__14196 = p__14195;
var map__14196__$1 = cljs.core.__destructure_map(map__14196);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14196__$1,cljs.core.cst$kw$event);
var player_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14196__$1,cljs.core.cst$kw$player_DASH_id);
var on_request_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14196__$1,cljs.core.cst$kw$on_DASH_request_DASH_close);
...
app.views.amount_history = (function app$views$amount_history(p__14197){
var map__14198 = p__14197;
var map__14198__$1 = cljs.core.__destructure_map(map__14198);
var history = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14198__$1,cljs.core.cst$kw$history);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$life_DASH_input_DASH__DASH_amount_DASH_history,(function (){var iter__4622__auto__ = (function app$views$amount_history_$_iter__14199(s__14200){
return (new cljs.core.LazySeq(null,(function (){
var s__14200__$1 = s__14200;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__14200__$1);
if(temp__5804__auto__){
var s__14200__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14200__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__14200__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__14202 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__14201 = (0);
while(true){
if((i__14201 < size__4621__auto__)){
var map__14203 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4620__auto__,i__14201);
var map__14203__$1 = cljs.core.__destructure_map(map__14203);
var time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14203__$1,cljs.core.cst$kw$time);
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14203__$1,cljs.core.cst$kw$amount);
cljs.core.chunk_append(b__14202,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,cljs.core.str.cljs$core$IFn$_invoke$arity$1(((((0) < amount))?"+":null)),amount], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,time], null)));

var G__14205 = (i__14201 + (1));
i__14201 = G__14205;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14202),app$views$amount_history_$_iter__14199(cljs.core.chunk_rest(s__14200__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14202),null);
}
} else {
var map__14204 = cljs.core.first(s__14200__$2);
var map__14204__$1 = cljs.core.__destructure_map(map__14204);
var time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14204__$1,cljs.core.cst$kw$time);
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14204__$1,cljs.core.cst$kw$amount);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,cljs.core.str.cljs$core$IFn$_invoke$arity$1(((((0) < amount))?"+":null)),amount], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,time], null)),app$views$amount_history_$_iter__14199(cljs.core.rest(s__14200__$2)));
}
} else {
return null;
}
...
app.views.life_input = (function app$views$life_input(p__14206){
var map__14207 = p__14206;
var map__14207__$1 = cljs.core.__destructure_map(map__14207);
var player_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14207__$1,cljs.core.cst$kw$player_DASH_id);
var with_let14208 = reagent.ratom.with_let_values(cljs.core.cst$kw$with_DASH_let14208);
var temp__5808__auto___14212 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___14212 == null)){
} else {
var c__12610__auto___14213 = temp__5808__auto___14212;
if((with_let14208.generation === c__12610__auto___14213.ratomGeneration)){
...
(with_let14208.generation = c__12610__auto___14213.ratomGeneration);
}

var init14209 = (with_let14208.length === (0));
var event = ((((init14209) || (cljs.core.not(with_let14208.hasOwnProperty((0))))))?(with_let14208[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let14208[(0)]));
var res14210 = (function (){var player = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$app$subs_SLASH_player,player_id], null)));
var map__14211 = player;
var map__14211__$1 = cljs.core.__destructure_map(map__14211);
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14211__$1,cljs.core.cst$kw$amount);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14211__$1,cljs.core.cst$kw$color);
var text_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14211__$1,cljs.core.cst$kw$text_DASH_color);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$counter,(function (){var iter__4622__auto__ = (function app$views$counter_$_iter__14214(s__14215){
return (new cljs.core.LazySeq(null,(function (){
var s__14215__$1 = s__14215;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__14215__$1);
if(temp__5804__auto__){
var s__14215__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14215__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__14215__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__14217 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__14216 = (0);
while(true){
if((i__14216 < size__4621__auto__)){
var id = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4620__auto__,i__14216);
cljs.core.chunk_append(b__14217,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.life_input,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$player_DASH_id,id], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,id], null)));

var G__14218 = (i__14216 + (1));
i__14216 = G__14218;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14217),app$views$counter_$_iter__14214(cljs.core.chunk_rest(s__14215__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14217),null);
}
} else {
var id = cljs.core.first(s__14215__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.life_input,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$player_DASH_id,id], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,id], null)),app$views$counter_$_iter__14214(cljs.core.rest(s__14215__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_LT__GT_,(function (){var G__14219 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$app$subs_SLASH_page], null)));
